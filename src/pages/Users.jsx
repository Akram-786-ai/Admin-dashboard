        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between">
                <input
                    ...
                    className="border rounded-lg p-2 sm:p-3 text-sm sm:text-base w-full sm:w-1/2 md:w-1/3 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />

                <select
                    value={sortBy}
                    onChange={(e) => setSortBy(e.target.value)}
                    className="border rounded-lg p-2 sm:p-3 text-sm sm:text-base w-full sm:w-1/2 md:w-1/4 focus:outline-none focus:ring-2 focus:ring-blue-400"
                >
